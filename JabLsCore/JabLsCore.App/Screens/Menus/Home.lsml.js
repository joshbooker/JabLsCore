...
myapp.Home.TilesByMenuId_ItemTap_execute = function (screen) {
	...
	lsWire.executeMenuTileTap(screen.TilesByMenuId, screen.EditingTiles, [
        ...
        { Id: "Colors", Tap: function () { myapp.Home.ChangeMenuId(screen,"Colors"); } }
	]);

};

myapp.Home.ChangeMenuId = function (screen, MenuId) {
    screen.MenuId = MenuId;
    myapp.Home.RefreshTiles_ButtonTap_execute(screen);
};
